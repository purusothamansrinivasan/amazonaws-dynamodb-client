...
public class GlobalSecondaryIndexInfo {
  ...
  public GlobalSecondaryIndexInfo indexName(@javax.annotation.Nullable String indexName) {
  ...
  public GlobalSecondaryIndexInfo keySchema(@javax.annotation.Nullable List<KeySchemaElement> keySchema) {
    this.keySchema = keySchema;
    return this;
  }

  public GlobalSecondaryIndexInfo addKeySchemaItem(KeySchemaElement keySchemaItem) {
  ...
  public GlobalSecondaryIndexInfo projection(@javax.annotation.Nullable Projection projection) {
  ...
  public GlobalSecondaryIndexInfo provisionedThroughput(@javax.annotation.Nullable ProvisionedThroughput provisionedThroughput) {
  ...
  public boolean equals(Object o) {
    ...
    GlobalSecondaryIndexInfo globalSecondaryIndexInfo = (GlobalSecondaryIndexInfo) o;
    return Objects.equals(this.indexName, globalSecondaryIndexInfo.indexName) &&
        Objects.equals(this.keySchema, globalSecondaryIndexInfo.keySchema) &&
        Objects.equals(this.projection, globalSecondaryIndexInfo.projection) &&
        Objects.equals(this.provisionedThroughput, globalSecondaryIndexInfo.provisionedThroughput);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GlobalSecondaryIndexInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GlobalSecondaryIndexInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GlobalSecondaryIndexInfo is not found in the empty JSON string", GlobalSecondaryIndexInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GlobalSecondaryIndexInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GlobalSecondaryIndexInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GlobalSecondaryIndexInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GlobalSecondaryIndexInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GlobalSecondaryIndexInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GlobalSecondaryIndexInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<GlobalSecondaryIndexInfo>() {
           @Override
           public void write(JsonWriter out, GlobalSecondaryIndexInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GlobalSecondaryIndexInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GlobalSecondaryIndexInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GlobalSecondaryIndexInfo
   * @throws IOException if the JSON string is invalid with respect to GlobalSecondaryIndexInfo
   */
  public static GlobalSecondaryIndexInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GlobalSecondaryIndexInfo.class);
  }

  /**
   * Convert an instance of GlobalSecondaryIndexInfo to an JSON string
   *
   * @return JSON string
   */
