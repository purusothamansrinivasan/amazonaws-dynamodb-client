...
public class ScanOutput {
  ...
  public ScanOutput items(@javax.annotation.Nullable List<Map<String, AttributeValue>> items) {
    this.items = items;
    return this;
  }
  ...
  public ScanOutput count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public ScanOutput scannedCount(@javax.annotation.Nullable Integer scannedCount) {
  ...
  public ScanOutput lastEvaluatedKey(@javax.annotation.Nullable Map<String, AttributeValue> lastEvaluatedKey) {
    this.lastEvaluatedKey = lastEvaluatedKey;
    return this;
  }

  public ScanOutput putLastEvaluatedKeyItem(String key, AttributeValue lastEvaluatedKeyItem) {
  ...
  public ScanOutput consumedCapacity(@javax.annotation.Nullable ConsumedCapacity consumedCapacity) {
