...
public class LocalSecondaryIndexDescription {
  ...
  public LocalSecondaryIndexDescription indexName(@javax.annotation.Nullable String indexName) {
  ...
  public LocalSecondaryIndexDescription keySchema(@javax.annotation.Nullable List<KeySchemaElement> keySchema) {
    this.keySchema = keySchema;
    return this;
  }

  public LocalSecondaryIndexDescription addKeySchemaItem(KeySchemaElement keySchemaItem) {
  ...
  public LocalSecondaryIndexDescription projection(@javax.annotation.Nullable Projection projection) {
  ...
  public LocalSecondaryIndexDescription indexSizeBytes(@javax.annotation.Nullable Integer indexSizeBytes) {
  ...
  public LocalSecondaryIndexDescription itemCount(@javax.annotation.Nullable Integer itemCount) {
  ...
  public LocalSecondaryIndexDescription indexArn(@javax.annotation.Nullable String indexArn) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("IndexName", "KeySchema", "Projection", "IndexSizeBytes", "ItemCount", "IndexArn"));
