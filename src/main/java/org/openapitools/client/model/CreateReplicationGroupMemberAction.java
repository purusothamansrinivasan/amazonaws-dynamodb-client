...
public class CreateReplicationGroupMemberAction {
  ...
  public CreateReplicationGroupMemberAction regionName(@javax.annotation.Nonnull String regionName) {
  ...
  public CreateReplicationGroupMemberAction kmSMasterKeyId(@javax.annotation.Nullable String kmSMasterKeyId) {
    this.kmSMasterKeyId = kmSMasterKeyId;
    return this;
  }

  /**
   * The KMS key that should be used for KMS encryption in the new replica. To specify a key, use its key ID, Amazon Resource Name (ARN), alias name, or alias ARN. Note that you should only provide this parameter if the key is different from the default DynamoDB KMS key &lt;code&gt;alias/aws/dynamodb&lt;/code&gt;.
  ...
  public CreateReplicationGroupMemberAction provisionedThroughputOverride(@javax.annotation.Nullable ProvisionedThroughputOverride provisionedThroughputOverride) {
  ...
  public CreateReplicationGroupMemberAction globalSecondaryIndexes(@javax.annotation.Nullable List<ReplicaGlobalSecondaryIndex> globalSecondaryIndexes) {
    this.globalSecondaryIndexes = globalSecondaryIndexes;
    return this;
  }

  public CreateReplicationGroupMemberAction addGlobalSecondaryIndexesItem(ReplicaGlobalSecondaryIndex globalSecondaryIndexesItem) {
  ...
  public CreateReplicationGroupMemberAction tableClassOverride(@javax.annotation.Nullable TableClass tableClassOverride) {
  ...
  public boolean equals(Object o) {
    ...
    CreateReplicationGroupMemberAction createReplicationGroupMemberAction = (CreateReplicationGroupMemberAction) o;
    return Objects.equals(this.regionName, createReplicationGroupMemberAction.regionName) &&
        Objects.equals(this.kmSMasterKeyId, createReplicationGroupMemberAction.kmSMasterKeyId) &&
        Objects.equals(this.provisionedThroughputOverride, createReplicationGroupMemberAction.provisionedThroughputOverride) &&
        Objects.equals(this.globalSecondaryIndexes, createReplicationGroupMemberAction.globalSecondaryIndexes) &&
        Objects.equals(this.tableClassOverride, createReplicationGroupMemberAction.tableClassOverride);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateReplicationGroupMemberAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateReplicationGroupMemberAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateReplicationGroupMemberAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateReplicationGroupMemberAction is not found in the empty JSON string", CreateReplicationGroupMemberAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateReplicationGroupMemberAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateReplicationGroupMemberAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateReplicationGroupMemberAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateReplicationGroupMemberAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateReplicationGroupMemberAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateReplicationGroupMemberAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateReplicationGroupMemberAction.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateReplicationGroupMemberAction>() {
           @Override
           public void write(JsonWriter out, CreateReplicationGroupMemberAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateReplicationGroupMemberAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateReplicationGroupMemberAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateReplicationGroupMemberAction
   * @throws IOException if the JSON string is invalid with respect to CreateReplicationGroupMemberAction
   */
  public static CreateReplicationGroupMemberAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateReplicationGroupMemberAction.class);
  }

  /**
   * Convert an instance of CreateReplicationGroupMemberAction to an JSON string
   *
   * @return JSON string
   */
