...
public class DeleteItemOutput {
  ...
  public DeleteItemOutput attributes(@javax.annotation.Nullable Map<String, AttributeValue> attributes) {
    this.attributes = attributes;
    return this;
  }

  public DeleteItemOutput putAttributesItem(String key, AttributeValue attributesItem) {
  ...
  /**
   * A map of attribute names to &lt;code&gt;AttributeValue&lt;/code&gt; objects, representing the item as it appeared before the &lt;code&gt;DeleteItem&lt;/code&gt; operation. This map appears in the response only if &lt;code&gt;ReturnValues&lt;/code&gt; was specified as &lt;code&gt;ALL_OLD&lt;/code&gt; in the request.
   * @return attributes
   */
  @javax.annotation.Nullable
  ...
  public DeleteItemOutput consumedCapacity(@javax.annotation.Nullable ConsumedCapacity consumedCapacity) {
  ...
  public DeleteItemOutput itemCollectionMetrics(@javax.annotation.Nullable ItemCollectionMetrics itemCollectionMetrics) {
