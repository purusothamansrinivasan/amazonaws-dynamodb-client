...
func DescribecontributorinsightsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeContributorInsightsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.DescribeContributorInsights", cfg.BaseURL)
		...
		var result models.DescribeContributorInsightsOutput
...
func CreateDescribecontributorinsightsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_DescribeContributorInsights",
		mcp.WithDescription("Returns information about contributor insights for a given table or global secondary index."),
		...
		mcp.WithString("IndexName", mcp.Description("Input parameter: The name of the global secondary index to describe, if applicable.")),
		mcp.WithString("TableName", mcp.Required(), mcp.Description("Input parameter: The name of the table to describe.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DescribecontributorinsightsHandler(cfg),
	}
}
