...
func PutitemHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutItemInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.PutItem", cfg.BaseURL)
		...
		var result models.PutItemOutput
...
func CreatePutitemTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_PutItem",
		...
		mcp.WithString("TableName", mcp.Required(), mcp.Description("Input parameter: The name of the table to contain the item.")),
