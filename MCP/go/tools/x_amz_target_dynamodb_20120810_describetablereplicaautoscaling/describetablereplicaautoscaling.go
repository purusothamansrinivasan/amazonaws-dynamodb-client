...
func DescribetablereplicaautoscalingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeTableReplicaAutoScalingInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.DescribeTableReplicaAutoScaling", cfg.BaseURL)
		...
		var result models.DescribeTableReplicaAutoScalingOutput
...
func CreateDescribetablereplicaautoscalingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_DescribeTableReplicaAutoScaling",
		mcp.WithDescription("<p>Describes auto scaling settings across replicas of the global table at once.</p> <important> <p>This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21 (Current)</a> of global tables.</p> </important>"),
		...
		mcp.WithString("TableName", mcp.Required(), mcp.Description("Input parameter: The name of the table.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DescribetablereplicaautoscalingHandler(cfg),
	}
}
