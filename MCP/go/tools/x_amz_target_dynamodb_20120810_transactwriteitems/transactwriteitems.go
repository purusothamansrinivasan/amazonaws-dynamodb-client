...
func TransactwriteitemsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.TransactWriteItemsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.TransactWriteItems", cfg.BaseURL)
		...
		var result models.TransactWriteItemsOutput
