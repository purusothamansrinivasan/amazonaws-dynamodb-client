...
func ExecutestatementHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ExecuteStatementInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.ExecuteStatement", cfg.BaseURL)
		...
		var result models.ExecuteStatementOutput
...
func CreateExecutestatementTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_ExecuteStatement",
		...
		mcp.WithString("NextToken", mcp.Description("Input parameter: Set this value to get remaining results, if <code>NextToken</code> was returned in the statement response.")),
		mcp.WithString("Parameters", mcp.Description("Input parameter: The parameters for the PartiQL statement, if any.")),
		...
		mcp.WithString("Statement", mcp.Required(), mcp.Description("Input parameter: The PartiQL statement representing the operation to run.")),
		mcp.WithString("ConsistentRead", mcp.Description("Input parameter: The consistency of a read operation. If set to <code>true</code>, then a strongly consistent read is used; otherwise, an eventually consistent read is used.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ExecutestatementHandler(cfg),
	}
}
