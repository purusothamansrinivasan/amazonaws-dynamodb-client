...
func TagresourceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.TagResource", cfg.BaseURL)
...
func CreateTagresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_TagResource",
		...
		mcp.WithString("Tags", mcp.Required(), mcp.Description("Input parameter: The tags to be assigned to the Amazon DynamoDB resource.")),
		mcp.WithString("ResourceArn", mcp.Required(), mcp.Description("Input parameter: Identifies the Amazon DynamoDB resource to which tags should be added. This value is an Amazon Resource Name (ARN).")),
	)
