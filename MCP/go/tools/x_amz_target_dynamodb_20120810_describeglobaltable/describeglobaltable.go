...
func DescribeglobaltableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeGlobalTableInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.DescribeGlobalTable", cfg.BaseURL)
		...
		var result models.DescribeGlobalTableOutput
...
func CreateDescribeglobaltableTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribeglobaltableHandler(cfg),
	}
}
