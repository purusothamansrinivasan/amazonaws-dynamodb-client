...
func ListglobaltablesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListGlobalTablesInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.ListGlobalTables", cfg.BaseURL)
		...
		var result models.ListGlobalTablesOutput
...
func CreateListglobaltablesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_ListGlobalTables",
		...
		mcp.WithString("ExclusiveStartGlobalTableName", mcp.Description("Input parameter: The first global table name that this operation will evaluate.")),
		mcp.WithString("RegionName", mcp.Description("Input parameter: Lists the global tables in a specific Region.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListglobaltablesHandler(cfg),
	}
}
