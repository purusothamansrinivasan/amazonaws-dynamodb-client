...
func UpdatetableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateTableInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.UpdateTable", cfg.BaseURL)
		...
		var result models.UpdateTableOutput
...
func CreateUpdatetableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_UpdateTable",
		...
		mcp.WithString("TableName", mcp.Required(), mcp.Description("Input parameter: The name of the table to be updated.")),
		mcp.WithString("TableClass", mcp.Description("Input parameter: The table class of the table to be updated. Valid values are <code>STANDARD</code> and <code>STANDARD_INFREQUENT_ACCESS</code>.")),
		mcp.WithString("AttributeDefinitions", mcp.Description("Input parameter: An array of attributes that describe the key schema for the table and indexes. If you are adding a new global secondary index to the table, <code>AttributeDefinitions</code> must include the key element(s) of the new index.")),
		...
		mcp.WithString("ReplicaUpdates", mcp.Description("Input parameter: <p>A list of replica update actions (create, delete, or update) for the table.</p> <note> <p>This property only applies to <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html\">Version 2019.11.21 (Current)</a> of global tables. </p> </note>")),
		mcp.WithString("ProvisionedThroughput", mcp.Description("Input parameter: The new provisioned throughput settings for the specified table or index.")),
		mcp.WithString("SSESpecification", mcp.Description("Input parameter: The new server-side encryption settings for the specified table.")),
