...
func DeletetableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteTableInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.DeleteTable", cfg.BaseURL)
		...
		var result models.DeleteTableOutput
...
func CreateDeletetableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_DeleteTable",
		...
		mcp.WithString("TableName", mcp.Required(), mcp.Description("Input parameter: The name of the table to delete.")),
	)
