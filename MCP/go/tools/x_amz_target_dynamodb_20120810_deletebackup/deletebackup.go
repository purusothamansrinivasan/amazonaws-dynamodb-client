...
func DeletebackupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DeleteBackupInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.DeleteBackup", cfg.BaseURL)
		...
		var result models.DeleteBackupOutput
...
func CreateDeletebackupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_DeleteBackup",
		mcp.WithDescription("<p>Deletes an existing backup of a table.</p> <p>You can call <code>DeleteBackup</code> at a maximum rate of 10 times per second.</p>"),
		...
		mcp.WithString("BackupArn", mcp.Required(), mcp.Description("Input parameter: The ARN associated with the backup.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletebackupHandler(cfg),
	}
}
