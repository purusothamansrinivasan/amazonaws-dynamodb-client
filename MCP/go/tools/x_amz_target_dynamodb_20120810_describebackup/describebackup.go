...
func DescribebackupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeBackupInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.DescribeBackup", cfg.BaseURL)
		...
		var result models.DescribeBackupOutput
...
func CreateDescribebackupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_DescribeBackup",
		mcp.WithDescription("<p>Describes an existing backup of a table.</p> <p>You can call <code>DescribeBackup</code> at a maximum rate of 10 times per second.</p>"),
		...
		mcp.WithString("BackupArn", mcp.Required(), mcp.Description("Input parameter: The Amazon Resource Name (ARN) associated with the backup.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DescribebackupHandler(cfg),
	}
}
