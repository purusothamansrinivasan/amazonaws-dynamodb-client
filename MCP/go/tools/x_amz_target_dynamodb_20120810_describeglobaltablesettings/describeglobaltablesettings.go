...
func DescribeglobaltablesettingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeGlobalTableSettingsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.DescribeGlobalTableSettings", cfg.BaseURL)
		...
		var result models.DescribeGlobalTableSettingsOutput
...
func CreateDescribeglobaltablesettingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_DescribeGlobalTableSettings",
		...
		mcp.WithString("GlobalTableName", mcp.Required(), mcp.Description("Input parameter: The name of the global table to describe.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DescribeglobaltablesettingsHandler(cfg),
	}
}
