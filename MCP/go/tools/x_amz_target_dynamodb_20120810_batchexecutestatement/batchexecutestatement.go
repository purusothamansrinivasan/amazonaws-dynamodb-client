...
func BatchexecutestatementHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.BatchExecuteStatementInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.BatchExecuteStatement", cfg.BaseURL)
		...
		var result models.BatchExecuteStatementOutput
...
func CreateBatchexecutestatementTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_BatchExecuteStatement",
		...
		mcp.WithString("Statements", mcp.Required(), mcp.Description("Input parameter: The list of PartiQL statements representing the batch to run.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    BatchexecutestatementHandler(cfg),
	}
}
