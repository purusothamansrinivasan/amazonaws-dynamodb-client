...
func TransactgetitemsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.TransactGetItemsInput
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=DynamoDB_20120810.TransactGetItems", cfg.BaseURL)
		...
		var result models.TransactGetItemsOutput
...
func CreateTransactgetitemsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=DynamoDB_20120810_TransactGetItems",
		...
		mcp.WithString("TransactItems", mcp.Required(), mcp.Description("Input parameter: An ordered array of up to 100 <code>TransactGetItem</code> objects, each of which contains a <code>Get</code> structure.")),
		mcp.WithString("ReturnConsumedCapacity", mcp.Description("Input parameter: A value of <code>TOTAL</code> causes consumed capacity information to be returned, and a value of <code>NONE</code> prevents that information from being returned. No other value is valid.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    TransactgetitemsHandler(cfg),
	}
}
