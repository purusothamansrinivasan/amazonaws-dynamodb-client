/**
 * MCP Server function for Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.
 */
...
class Post_X_Amz_Target_Dynamo_Db_20120810_List_Contributor_InsightsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Dynamo_Db_20120810_List_Contributor_InsightsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("TableName")) {
            queryParams.add("TableName=" + args.get("TableName"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_dynamo_db_20120810_list_contributor_insights" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Dynamo_Db_20120810_List_Contributor_InsightsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_dynamo_db_20120810_list_contributor_insights",
            "Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Dynamo_Db_20120810_List_Contributor_InsightsHandler(config));
    }
