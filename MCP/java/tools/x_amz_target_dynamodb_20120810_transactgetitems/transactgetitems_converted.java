...
class Post_X_Amz_Target_Dynamo_Db_20120810_Transact_Get_ItemsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Dynamo_Db_20120810_Transact_Get_ItemsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("ReturnConsumedCapacity")) {
            queryParams.add("ReturnConsumedCapacity=" + args.get("ReturnConsumedCapacity"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_dynamo_db_20120810_transact_get_items" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Dynamo_Db_20120810_Transact_Get_ItemsTool(MCPServer.APIConfig config) {
        ...
        TransactItemsProperty.put("description", "Input parameter: An ordered array of up to 100 <code>TransactGetItem</code> objects, each of which contains a <code>Get</code> structure.");
        ...
        ReturnConsumedCapacityProperty.put("description", "Input parameter: A value of <code>TOTAL</code> causes consumed capacity information to be returned, and a value of <code>NONE</code> prevents that information from being returned. No other value is valid.");
        properties.put("ReturnConsumedCapacity", ReturnConsumedCapacityProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_dynamo_db_20120810_transact_get_items",
        ...
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Dynamo_Db_20120810_Transact_Get_ItemsHandler(config));
    }
