...
class Post_X_Amz_Target_Dynamo_Db_20120810_Describe_Global_TableMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Dynamo_Db_20120810_Describe_Global_TableHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("GlobalTableName")) {
            queryParams.add("GlobalTableName=" + args.get("GlobalTableName"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_dynamo_db_20120810_describe_global_table" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Dynamo_Db_20120810_Describe_Global_TableTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_dynamo_db_20120810_describe_global_table",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Dynamo_Db_20120810_Describe_Global_TableHandler(config));
    }
