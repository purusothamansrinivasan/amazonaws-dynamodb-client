/**
 * MCP Server function for <p>Describes an existing backup of a table.</p> <p>You can call <code>DescribeBackup</code> at a maximum rate of 10 times per second.</p>
 */
...
class Post_X_Amz_Target_Dynamo_Db_20120810_Describe_BackupMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Dynamo_Db_20120810_Describe_BackupHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("BackupArn")) {
            queryParams.add("BackupArn=" + args.get("BackupArn"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_dynamo_db_20120810_describe_backup" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Dynamo_Db_20120810_Describe_BackupTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_dynamo_db_20120810_describe_backup",
        ...
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Dynamo_Db_20120810_Describe_BackupHandler(config));
    }
