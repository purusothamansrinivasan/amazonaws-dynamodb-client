/**
 * MCP Server function for Lists completed imports within the past 90 days.
 */
...
class Post_X_Amz_Target_Dynamo_Db_20120810_List_ImportsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Dynamo_Db_20120810_List_ImportsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("TableArn")) {
            queryParams.add("TableArn=" + args.get("TableArn"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_dynamo_db_20120810_list_imports" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Dynamo_Db_20120810_List_ImportsTool(MCPServer.APIConfig config) {
        ...
        PageSizeProperty.put("description", "Pagination limit");
        ...
        TableArnProperty.put("required", false);
        TableArnProperty.put("description", "Input parameter: The Amazon Resource Name (ARN) associated with the table that was imported to.");
        properties.put("TableArn", TableArnProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_dynamo_db_20120810_list_imports",
            "Lists completed imports within the past 90 days.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Dynamo_Db_20120810_List_ImportsHandler(config));
    }
