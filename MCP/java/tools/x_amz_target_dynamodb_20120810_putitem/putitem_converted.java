...
class Post_X_Amz_Target_Dynamo_Db_20120810_Put_ItemMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Dynamo_Db_20120810_Put_ItemHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("Item")) {
            queryParams.add("Item=" + args.get("Item"));
        }
        ...
        if (args.containsKey("ExpressionAttributeValues")) {
            queryParams.add("ExpressionAttributeValues=" + args.get("ExpressionAttributeValues"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_dynamo_db_20120810_put_item" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Dynamo_Db_20120810_Put_ItemTool(MCPServer.APIConfig config) {
        ...
        TableNameProperty.put("description", "Input parameter: The name of the table to contain the item.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_dynamo_db_20120810_put_item",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Dynamo_Db_20120810_Put_ItemHandler(config));
    }
