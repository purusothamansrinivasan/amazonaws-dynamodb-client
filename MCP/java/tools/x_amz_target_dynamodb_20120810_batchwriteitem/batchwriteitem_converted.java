...
class Post_X_Amz_Target_Dynamo_Db_20120810_Batch_Write_ItemMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Dynamo_Db_20120810_Batch_Write_ItemHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("ReturnItemCollectionMetrics")) {
            queryParams.add("ReturnItemCollectionMetrics=" + args.get("ReturnItemCollectionMetrics"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_dynamo_db_20120810_batch_write_item" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Dynamo_Db_20120810_Batch_Write_ItemTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_dynamo_db_20120810_batch_write_item",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Dynamo_Db_20120810_Batch_Write_ItemHandler(config));
    }
