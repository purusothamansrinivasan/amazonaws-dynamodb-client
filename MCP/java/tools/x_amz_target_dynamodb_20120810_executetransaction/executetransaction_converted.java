...
class Post_X_Amz_Target_Dynamo_Db_20120810_Execute_TransactionMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Dynamo_Db_20120810_Execute_TransactionHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("TransactStatements")) {
            queryParams.add("TransactStatements=" + args.get("TransactStatements"));
        }
                
                String queryString = queryParams.isEmpty() ? "" : "?" + String.join("&", queryParams);
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_dynamo_db_20120810_execute_transaction" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Dynamo_Db_20120810_Execute_TransactionTool(MCPServer.APIConfig config) {
        ...
        ClientRequestTokenProperty.put("description", "Input parameter: Set this value to get remaining results, if <code>NextToken</code> was returned in the statement response.");
        ...
        ReturnConsumedCapacityProperty.put("description", "Input parameter: Determines the level of detail about either provisioned or on-demand throughput consumption that is returned in the response. For more information, see <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_TransactGetItems.html\">TransactGetItems</a> and <a href=\"https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_TransactWriteItems.html\">TransactWriteItems</a>.");
        properties.put("ReturnConsumedCapacity", ReturnConsumedCapacityProperty);
        Map<String, Object> TransactStatementsProperty = new HashMap<>();
        TransactStatementsProperty.put("type", "string");
        TransactStatementsProperty.put("required", true);
        TransactStatementsProperty.put("description", "Input parameter: The list of PartiQL statements representing the transaction to run.");
        properties.put("TransactStatements", TransactStatementsProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_dynamo_db_20120810_execute_transaction",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Dynamo_Db_20120810_Execute_TransactionHandler(config));
    }
